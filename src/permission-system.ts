...
export class PermissionSystem {
  private static readonly TOOL_PERMISSIONS = new Map<string, keyof UserPermissions | Array<keyof UserPermissions>>([
    ...
    ['dhis2_update_program', 'canManagePrograms'],
    ['dhis2_delete_program', 'canDeleteMetadata'],
    ...
    ['dhis2_list_option_sets', 'canViewMetadata'],
    ['dhis2_create_option_set', 'canCreateMetadata'],
    ['dhis2_list_options', 'canViewMetadata'],
    ['dhis2_create_option', 'canCreateMetadata'],
    ['dhis2_list_program_stages', 'canViewMetadata'],
    ['dhis2_create_program_stage', 'canManagePrograms'],
    ['dhis2_update_program_stage', 'canManagePrograms'],
    ['dhis2_delete_program_stage', 'canDeleteMetadata'],
    ['dhis2_list_program_rules', 'canViewMetadata'],
    ['dhis2_create_program_rule', 'canManagePrograms'],
    ['dhis2_update_program_rule', 'canManagePrograms'],
    ['dhis2_delete_program_rule', 'canDeleteMetadata'],
    ['dhis2_list_program_rule_variables', 'canViewMetadata'],
    ['dhis2_create_program_rule_variable', 'canManagePrograms'],
    ['dhis2_update_program_rule_variable', 'canManagePrograms'],
    ['dhis2_delete_program_rule_variable', 'canDeleteMetadata'],
    ['dhis2_list_program_indicators', 'canViewMetadata'],
    ['dhis2_create_program_indicator', 'canManagePrograms'],
    ['dhis2_update_program_indicator', 'canManagePrograms'],
    ['dhis2_delete_program_indicator', 'canDeleteMetadata'],
    ['dhis2_list_relationship_types', 'canViewMetadata'],
    ['dhis2_create_relationship_type', 'canManagePrograms'],
    ['dhis2_update_relationship_type', 'canManagePrograms'],
    ['dhis2_delete_relationship_type', 'canDeleteMetadata'],
    
    // Tracker Data
    ['dhis2_list_tracked_entity_instances', 'canViewTEI'],
    ['dhis2_create_tracked_entity_instance', 'canEnrollTEI'],
    ['dhis2_update_tracked_entity_instance', 'canManageTrackerData'],
    ['dhis2_delete_tracked_entity_instance', 'canDeleteData'],
    ['dhis2_list_enrollments', 'canViewTEI'],
    ['dhis2_create_enrollment', 'canEnrollTEI'],
    ['dhis2_update_enrollment', 'canManageTrackerData'],
    ['dhis2_delete_enrollment', 'canDeleteData'],
    ['dhis2_list_events', 'canViewTEI'],
    ['dhis2_create_event', 'canManageTrackerData'],
    ['dhis2_update_event', 'canManageTrackerData'],
    ['dhis2_delete_event', 'canDeleteData'],
